...
#PWMでPSG等を鳴らす設定
Pwm_enabled = True
Pwm_pin1 = 27  #スピーカの+ピンを繋ぐGPIOピン番号 -1にすると無効
...
Num_loops = 0     # ループは1回 / 0にするとループしない
...
# detect switchに使うピンを初期化
detsw = machine.Pin(Detect_pin, machine.Pin.IN, machine.Pin.PULL_UP)
